...
<main class="flex h-screen w-screen items-center justify-center bg-[#1e1f22] text-white">
	...
	{:else}
		<!-- temporary view when workspace is selected -->
		<div class="text-center">
			<h1 class="mb-2 text-2xl font-bold text-green-400">Workspace Connected!</h1>
			<p class="text-gray-400">{workspace}</p>
			<p class="mt-4 text-sm text-gray-500">In the next step, we will load the database here.</p>
		</div>
	{/if}
</main>